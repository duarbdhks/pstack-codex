...
| Multi-model panels (arena, architect, interrogate, how-critics) | Default panel is `gpt-5.6-sol` + `gpt-5.6-luna` + `grok-4.6`. Claude Code can restore the sidecar panel via `/setup-pstack`. |
